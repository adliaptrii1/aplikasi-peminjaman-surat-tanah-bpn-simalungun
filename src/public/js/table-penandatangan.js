...
async function writeTable() {
    ...
    try {
        ...
        for (let i = 0; i < data.length; i++) {
            let buttons = `<li>
                <button type="button" class="btn btn-primary  my-1 mx-0 px-1 py-0 fs-6"   style="width : 90px;" onclick="updateOfficer(${i})">
                    <i class="fas fa-pencil me-1"></i> Ubah
                </button>
                
            </li>
            <li>
                <button type="button" class="btn btn-danger my-1 mx-0 px-1 py-0" fs-6 style="width : 90px;" onclick="deleteOfficer(${data[i].id})">
...
function sortTable() {
    ...
    rows.forEach((row, index) => {
        let buttons = `
            <ul style="list-style-type : none; padding: 0;">
            <li>
                <button type="button" class="btn btn-primary  my-1 mx-0 px-1 py-0 fs-6"   style="width : 90px;" onclick="updateOfficer(${index})">
        ...
        if (isAdmin) {
            buttons += 
                `<li>
                    <button type="button" class="btn btn-success my-1 mx-0 px-1 py-0" fs-6 style="width : 90px;" onclick="deleteOfficer(${row.querySelectorAll('td')[0].textContent})">
